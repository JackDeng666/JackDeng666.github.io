...
export const BgIcon = ({
  ...
  const length = useTransform(scrollYProgress, [0.25, 0.6], [0, 1])
  ...
  const fill = useTransform(scrollYProgress, [0.5, 0.6], ['#3f3d56', '#3578e5'])

  const fillNotebook = useTransform(
    scrollYProgress,
    [0.5, 0.6, 0.8, 1],
    ['#3f3d56', '#3578e5', '#fff', '#fff']
  )

  const fillDesktop = useTransform(
    scrollYProgress,
    [0.5, 0.8, 1],
    ['#3f3d56', '#fff', '#fff']
  )

  const fillBlue = useTransform(
    scrollYProgress,
    [0.5, 1],
    ['#3f3d56', '#3578e5']
  )

  const fillGrey = useTransform(
    scrollYProgress,
    [0.5, 1],
    ['rgba(230, 230, 230, 0)', 'rgba(230, 230, 230, 1)']
  )

  const skinFill = useTransform(
    scrollYProgress,
    [0.33, 0.66],
    ['rgba(255, 182, 182, 0)', 'rgb(255, 182, 182, 1)']
  )

  const bodyFill = useTransform(
    scrollYProgress,
    [0.33, 0.66],
    ['rgba(63, 61, 86, 0)', 'rgba(63, 61, 86, 1)']
  )

  const headFill = useTransform(
    scrollYProgress,
    [0.33, 0.66],
    ['rgba(47, 46, 65, 0)', 'rgba(47, 46, 65, 1)']
  )

  const blackFill = useTransform(
    scrollYProgress,
    [0.33, 0.66],
